...
export default function ProductForm({
    ...
    const initialMetaDescription = product?.metaDescription ?? "";
  ...
  return (
        <div className="rounded-xl border border-neutral-200 bg-white shadow-sm">
              <div className="flex items-start gap-3 border-b border-neutral-200 p-6">
                      ...
                      <div>
                                <h2 className="font-semibold text-neutral-900">{product ? "Edit Product" : "Add Product"}</h2>h2>
              ...
              <form action={action} className="space-y-6 p-6">
                      <div className="rounded-lg border border-[#cfe8ee] bg-[#f3fbfc] p-4">
                                ...
                                <select
                                            ...
                                            >
                                            <option value="">— Select a compound —</option>option>
                                  {PEPTIDE_TEMPLATES.map((t) => (
                                                            <option key={t.id} value={t.id}>{t.label}</option>option>
                                                          ))}
                                </select>select>
                      ...
                      <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <p className="mt-1 text-xs text-neutral-500">Shown to customers as: {pricePreview}</p>p>
                                            )}
                                </div>div>
                          ...
                          <option key={f} value={f}>{f}</option>option>
                                                          ...
                                                          <option value="Other">Other (type below)</option>option>
                                            </select>select>
                      ...
                      <div className="border-t border-neutral-200 pt-6">
                                <h3 className="font-semibold text-neutral-900">SEO &amp; Description</h3>h3>
                                <p className="mt-1 text-sm text-neutral-500">
                                            Shown on the product page and used for the page&apos;s search-engine title and description.
                                </p>p>
                                ...
                                <div className="mt-4">
                                            ...
                                            <textarea
                                                            ...
                                                            name="description"
                                                            rows={4}
                                                            placeholder="A short paragraph describing this product for customers and researchers."
                                                            value={description}
                                                            onChange={(e) => setDescription(e.target.value)}
                                                            className={inputClass}
                                                          />
                                            <p className="mt-1 text-xs text-neutral-500">Displayed on the product page, under the title.</p>p>
                                </div>div>
                      
                                <div className="mt-4">
                                            <label className="text-sm font-medium text-neutral-700" htmlFor="metaDescription">
                                                          Meta Description
                                            </label>label>
                                            <textarea
                                                            id="metaDescription"
                                                            ...
                                                            rows={2}
                                                            maxLength={160}
                                                            placeholder="A concise, ~150-160 character summary for search engine results."
                                                            value={metaDescription}
                                                            onChange={(e) => setMetaDescription(e.target.value)}
                                                            className={inputClass}
                                                          />
                                            <p className="mt-1 text-xs text-neutral-500">
                                              {metaDescription.length}/160 characters — used for the search engine snippet. Falls back to the
                                                          description above if left blank.
                                            </p>p>
                                </div>div>
                      </div>div>
              
                      <div className="border-t border-neutral-200 pt-6">
                                <h3 className="font-semibold text-neutral-900">Specifications</h3>h3>
                      ...
                      <div className="border-t border-neutral-200 pt-6">
                                <h3 className="font-semibold text-neutral-900">Variants (dropdown pricing)</h3>h3>
                                <p className="mt-1 text-sm text-neutral-500">
                      ...
                      <div className="border-t border-neutral-200 pt-6">
                                <label className="text-sm font-medium text-neutral-700">Product Image</label>label>
                                <p className="text-sm text-neutral-500">Drag and drop an image, or browse to upload</p>p>
                                <div className="mt-3">
