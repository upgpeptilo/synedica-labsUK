    ...
    <div className="rounded-xl border border-neutral-200 bg-white shadow-sm">
      ...
      <form action={action} className="space-y-6 p-6">
        ...
        <div className="border-t border-neutral-200 pt-6">
          <h3 className="font-semibold text-neutral-900">SEO &amp; Description</h3>
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              className={inputClass}
            />
            <p className="mt-1 text-xs text-neutral-500">Displayed on the product page, under the title.</p>
          </div>
