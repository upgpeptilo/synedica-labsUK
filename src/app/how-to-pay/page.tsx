...
const cryptoSteps = [
  {
    title: "1. Select Crypto Payment at Checkout",
    body: 'Choose "Crypto" as your payment method during checkout.',
  },
  {
    title: "2. Send the Exact Amount",
    body: "You'll be redirected to a secure Bitcoin address generated by Blockonomics. Send the exact BTC amount shown on your order.",
  },
  {
    title: "3. Automatic Payment Confirmation",
    body: "Your transaction is verified automatically on the blockchain — no manual confirmation required.",
  },
  {
    title: "4. Shipping Begins",
    body: "Once your crypto payment is confirmed, your order is processed and shipped securely.",
  },
];
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 text-neutral-700">
      ...
      <p className="mt-6">
        ...
        <br />
        You can choose between <span className="font-semibold text-dark">Bank Transfer</span> or{" "}
        <span className="font-semibold text-dark">Crypto Payments via Blockonomics</span> for a smooth and
        private transaction experience.
      </p>
      ...
      <div className="mt-10 border-t border-neutral-200 pt-8">
        <h2 className="font-heading text-lg font-bold text-dark">Crypto Payment (via BITCOIN &amp; USDT)</h2>
        <div className="mt-4 space-y-5">
